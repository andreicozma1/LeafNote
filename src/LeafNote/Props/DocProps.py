...
class DocProps:
    ...
    def __init__(self):
        ...
        self.dict_title_styles = {
            ...
            f'{self.text_update_title}Normal Text': None,
            "Title": self.title,
            f'{self.text_update_title}Title': None,
            "Subtitle": self.subtitle,
            f'{self.text_update_title}Subtitle': None,
            "Header 1": self.heading1,
            f'{self.text_update_title}Header 1': None,
            "Header 2": self.heading2,
            f'{self.text_update_title}Header 2': None,
            "Header 3": self.heading3,
            f'{self.text_update_title}Header 3': None,
            "Header 4": self.heading4,
            f'{self.text_update_title}Header 4': None,
