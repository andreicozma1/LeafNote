...
from LeafNote.Layout import Utils


class SearchReplace(QWidget):
    """
    ...
    def __init__(self, path_res, document):
        ...
        self.search = Utils.SearchDoc(self, self.document, self.path_res)
        self.replace = Utils.ReplaceDoc(self, self.document)
